...
namespace MvcMusicStore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    CounterHelper<PerformanceCounter> counterHelper = 
                        PerformanceHelper.CreateCounterHelper<PerformanceCounter>("Test project");
                    counterHelper.Increment(PerformanceCounter.LogInCounter);
        ...
        public ActionResult LogOff()
        {
            ...
            CounterHelper<PerformanceCounter> counterHelper = 
                PerformanceHelper.CreateCounterHelper<PerformanceCounter>("Test project");
            counterHelper.Increment(PerformanceCounter.LogOffCounter);
            return RedirectToAction("Index", "Home");
        }
